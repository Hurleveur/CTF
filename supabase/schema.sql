...
INSERT INTO public.challenges (title, description, category, difficulty, flag, points, hints) VALUES
  ...
  ('Intern Account Access', 'The company intern Alex has a weak password. His email is alex@robo.tech and his password follows a common pattern used by sleep-deprived developers.', 'misc', 'medium', 'RBT{sleepy_intern_logged_in}', 200, ARRAY['The intern works late hours and is often sleep-deprived', 'His password might be related to his work schedule or habits', 'Try common password patterns: TODO + something simple', 'Check if the password is literally TODOpassword'])
