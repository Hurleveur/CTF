                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <p className="text-green-700">
                      Creative problem-solving, code analysis, web application testing, API exploration, social engineering within the platform, and ethical reconnaissance are all fair game! If you find a vulnerability we didn&apos;t intend (without a RBT{} flag) please tell us and you&apos;ll get a permanent spot on the website.
                    </p>
                  </div>
