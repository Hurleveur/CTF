                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                    <div className="flex items-start space-x-4">
                      <input
                        ...
                        onChange={handleChange}
                        className="w-5 h-5 text-blue-600 bg-white border-2 border-blue-300 rounded focus:ring-blue-500 focus:ring-2 focus:ring-offset-2 mt-0.5 cursor-pointer"
                      />
                      <label htmlFor="createDefaultProject" className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer flex-1">
                        <span className="font-semibold text-blue-800 dark:text-blue-200">Start with a default robotics project</span>
                  ...
                  <div className={`border-2 rounded-lg p-4 transition-colors ${
                    ...
                    <div className="flex items-start space-x-4">
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-5 h-5 text-blue-600 bg-white border-2 rounded focus:ring-blue-500 focus:ring-2 focus:ring-offset-2 mt-0.5 cursor-pointer ${
                          errors.acceptPrivacyPolicy 
                            ? 'border-red-400' 
                            : formData.acceptPrivacyPolicy 
                            ? 'border-green-400' 
                      ...
                      <div className="flex-1">
                        <label htmlFor="acceptPrivacyPolicy" className="text-sm cursor-pointer block">
                          <span className={`font-semibold ${
                            ...
                            I have read and accept the Terms of Service and the{' '}
                            <Link 
                              href="/privacy" 
                              target="_blank" 
                        ...
                        {errors.acceptPrivacyPolicy && (
                          <p className="text-red-600 dark:text-red-400 text-xs mt-2 font-medium">{errors.acceptPrivacyPolicy}</p>
                        )}
                      </div>
                    </div>
                  </div>
